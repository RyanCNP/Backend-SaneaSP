...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      console.log('Erro na seed INSERT-CATEGORIA-DENUNCIA - rollback realizado:', error.errors || error.message);
      throw error;
    }
  },

  async down(queryInterface, Sequelize) {
    await queryInterface.bulkDelete('categoria_denuncia', null, {});
    await queryInterface.sequelize.query(
      "DELETE FROM sqlite_sequence WHERE name='categoria_denuncia';"
    );
  }
};
